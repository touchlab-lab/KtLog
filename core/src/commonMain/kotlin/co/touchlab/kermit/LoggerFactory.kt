...
object LoggerFactory {
    init {
        if (isStrictModel)
            throw IllegalStateException("Logger does not function with the strict memory model")
        ProviderConfig.provider = EmptyLoggerFactoryProvider
    }
...
internal expect val isStrictModel: Boolean